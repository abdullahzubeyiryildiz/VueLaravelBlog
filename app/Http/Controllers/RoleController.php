...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'Başarıyla role Oluşturuldu '. $role->display_name . ' role database kaydedildi.');
    ...
    Session::flash('success', 'Güncelleme Başarılı '. $role->display_name . ' rol yetkileri database kaydedildi..');
