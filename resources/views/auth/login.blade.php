      ...
      <div class="card">
        <div class="card-content">
          ...
          <form action="{{route('login')}}" method="POST" role="form">
            ...
            <b-checkbox name="remember" class="m-t-20">Beni Hatırla</b-checkbox>
  
            <button class="button is-primary is-outlined is-fullwidth m-t-30">Log In</button>
          </form>
        </div> <!-- end of .card-content -->
      </div> <!-- end of .card -->
      <h5 class="has-text-centered m-t-20"><a href="{{route('password.request')}}" class="is-muted">Şifremi Unuttum?</a></h5>
    </div>
  </div>
